...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.naira.autos/adawat/vin-checker-arabic',
    languages: {
      ...
      ar: 'https://www.naira.autos/adawat/vin-checker-arabic',
  ...
  openGraph: {
    ...
    url: 'https://www.naira.autos/adawat/vin-checker-arabic',
  },
};
...
const SCHEMA = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://www.naira.autos/adawat/vin-checker-arabic',
      ...
      breadcrumb: {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'فحص رقم الهيكل', item: 'https://www.naira.autos/adawat/vin-checker-arabic' },
        ],
      },
    },
    {
