...
const staticPages = [
  ...
  // French has 2 (mecanicien-virtuel, combien-vaut-ma-voiture),
  // Portuguese has 2 (meu-mecanico-virtual, quanto-vale-meu-carro),
  // German now has 2 (virtueller-mechaniker, was-ist-mein-auto-wert),
  // all still under
