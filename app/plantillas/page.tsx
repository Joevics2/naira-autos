...
// Plain alias of /documents — same data, same component, same text. The
// templates themselves have no language dimension (each is just whatever
// language it was written in per country), so there's nothing to
// translate here. Kept as a live URL with noindex + canonical pointing at
// /documents, rather than a separate translated copy of the same list.
