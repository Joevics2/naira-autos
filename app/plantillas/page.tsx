...
export const metadata: Metadata = {
  ...
  // This lists the exact same templates as /documents, just with Spanish
  // page chrome — canonical points at the English index and this page is
  // kept out of search results so it doesn't compete with it, while
  // staying live and linkable for people who prefer a Spanish UI.
