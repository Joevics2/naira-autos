...
export const metadata: Metadata = {
  title: 'Nigeria Road Trip Fuel Cost Calculator — Calculate Gas Cost for Any Nigerian Route',
  description: 'Calculate the exact petrol cost of driving between Nigerian cities. Lagos to Abuja, Lagos to Port Harcourt, and 35+ more routes. Pick your car, drag the pump price slider — instant naira fuel cost.',
  alternates: { canonical: 'https://www.naira.autos/tools/road-trip-calculator' },
  openGraph: {
    title: 'Nigeria Road Trip Fuel Cost Calculator | Naira Autos',
    description: 'Free Nigerian road trip fuel cost calculator. 35+ city routes, 100+ car models, live pump price slider. Calculate petrol cost for any Nigerian road trip.',
    url: 'https://www.naira.autos/tools/road-trip-calculator',
  },
  keywords: ['road trip cost calculator','fuel cost calculator','calculate gas for trip','trip cost calculator','fuel trip calculator','road trip fuel calculator','petrol cost calculator','calculate fuel cost for trip','journey fuel cost calculator','gas cost calculator trip','travel cost calculator','trip cost estimator','calculate petrol cost for trip','lagos to abuja fuel cost','lagos abuja distance','road trip cost nigeria','fuel cost nigeria','trip expense calculator'],
};
  ...
  '@graph': [
    {
      ...
      description: 'Calculate the fuel cost of driving between Nigerian cities. 35+ routes, 100+ car models.',
      url: 'https://www.naira.autos/tools/road-trip-calculator',
      breadcrumb: {
        '@type': 'BreadcrumbList',
        itemListElement: [
...
const POPULAR_ROUTES = [
  { from:'Lagos',         to:'Abuja',         km:791,  via:'Ore–Okene–Lokoja',     camryEst:71320 },
  { from:'Lagos',         to:'Port Harcourt', km:669,  via:'Benin City–Warri',     camryEst:60210 },
  { from:'Lagos',         to:'Ibadan',        km:128,  via:'Sagamu Interchange',   camryEst:11520 },
  { from:'Lagos',         to:'Benin City',    km:320,  via:'Ore–Sagamu',           camryEst:28800 },
  { from:'Abuja',         to:'Kano',          km:370,  via:'Kaduna',               camryEst:33300 },
  { from:'Port Harcourt', to:'Calabar',       km:212,  via:'Aba',                  camryEst:19080 },
  { from:'Abuja',         to:'Enugu',         km:370,  via:'Makurdi',              camryEst:33300 },
  { from:'Lagos',         to:'Enugu',         km:518,  via:'Benin–Asaba–Onitsha',  camryEst:46620 },
];
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-4 sm:px-6 pt-10 pb-12">
          ...
          <div className="max-w-2xl">
            ...
            <h1 className="font-black uppercase text-white leading-none tracking-tight mb-3"
              ...
              Road Trip<br /><span className="text-amber-400">Fuel Cost Calculator</span>
            </h1>
            <p className="text-white/80 text-lg font-semibold leading-snug mb-2">How much will that journey cost in petrol?</p>
            <p className="text-white/75 text-sm leading-relaxed">Pick your origin, destination, and car model — then drag the pump price slider to your current station price. Get an instant naira fuel estimate for any Nigerian road trip.</p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 py-16 space-y-14">
          ...
          <div>
            <h2 className="text-2xl font-black uppercase text-foreground mb-2" style={{ fontFamily: "'Barlow Condensed', Impact, sans-serif" }}>
              Fuel Cost Estimates — Popular Nigerian Routes
            </h2>
            <p className="text-sm text-muted-foreground mb-4">Toyota Camry 2.5 at mixed driving (~9L/100km) and ₦1,000/litre pump price. Actual cost depends on your car and driving style.</p>
            <div className="overflow-x-auto rounded-2xl border border-border">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-border">
                  {POPULAR_ROUTES.map(({ from, to, km, via, camryEst }) => (
