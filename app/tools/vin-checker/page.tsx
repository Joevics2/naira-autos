...
export const metadata: Metadata = {
  ...
  description: 'Free VIN decoder and VIN checker for any car, anywhere in the world. Decode any vehicle VIN or chassis number — make, model, year, engine specs, assembly origin. Essential free VIN check for used car buyers in the US, UK, UAE, Nigeria, and beyond.',
  ...
  '@graph': [
    ...
    },
    {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Is this VIN decoder free?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. 100% free. We use the publicly accessible NHTSA API. No account, login, or payment required. Works for US, Canadian, and Mexican vehicles — the majority of Tokunbo cars imported to Nigeria and used cars shipped to the UAE, Gulf, and Africa.' } },
        { '@type': 'Question', name: 'What is the difference between a VIN and a chassis number?', acceptedAnswer: { '@type': 'Answer', text: 'They are the same 17-character identifier. Internationally it is called VIN. In Nigeria, the UAE, Saudi Arabia, and other Commonwealth or Gulf markets the same code is often called the chassis number.' } },
        { '@type': 'Question', name: 'Does VIN decode work for Tokunbo cars imported to Nigeria?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Most Tokunbo cars in Nigeria originate from the US, Canada, or Mexico — all in the NHTSA database. European, UK, or Asian-origin vehicles may return limited data.' } },
      ...
      <div className="relative bg-[#080C10] overflow-hidden">
        ...
        <div className="relative z-10 max-w-screen-xl mx-auto px-4 sm:px-6 pt-10 pb-12">
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-white/75 text-sm leading-relaxed">Enter the 17-character VIN (chassis number) from the dashboard, door jamb, or engine bay. Get a free VIN number lookup — make, model, year, engine specs, and assembly origin. No login required, whether you're buying in Lagos, Dubai, Riyadh, London, or Los Angeles.</p>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-3 text-sm text-muted-foreground leading-relaxed">
                  ...
                  <p><strong className="text-foreground">Nigeria &amp; West Africa</strong> — most Tokunbo cars sold in Lagos, Abuja, and Port Harcourt were US or Canadian-market vehicles before export, so this <strong className="text-foreground">chassis number checker</strong> is the fastest way to confirm a seller's claims about year, engine, and trim before you commit to a purchase. It's just as useful for a Direct Tokunbo shipped straight from a US port as it is for a locally-used-locally-used (Naija-used) car with a murky ownership chain — in both cases, the factory-stamped chassis number doesn't lie even when the paperwork does.</p>
              ...
              <div>
                ...
                <div className="space-y-3 text-sm text-muted-foreground leading-relaxed">
                  <p>A <strong className="text-foreground">free VIN lookup</strong> returns what the car was when it left the factory. For what has happened since — accidents, odometer rollback, title status (salvage, flood, rebuilt) — you need a paid <strong className="text-foreground">vehicle history report</strong> from Carfax or AutoCheck. For any high-value used car purchase, whether it's a Tokunbo Camry in Lagos or a re-exported Tahoe in Dubai, a paid history report is strongly recommended alongside this free spec check.</p>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  { q: 'What is a car VIN number used for?', a: 'The VIN identifies a specific vehicle for spec verification, history checks, registration, insurance, and recall notices. In Nigeria, the UAE, and most Commonwealth markets, the VIN (chassis number) is required for registration and ownership transfer.' },
                  ...
                  { q: 'Is a free VIN check available in Nigeria for Tokunbo cars?', a: 'Yes. Most Tokunbo vehicles were sold new in the US or Canada before export, so this free chassis number check decodes them accurately, including engine size and factory trim.' },
