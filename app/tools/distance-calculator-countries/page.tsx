...
const COUNTRIES: { code: string; name: string; flag: string; href?: string; live: boolean }[] = [
  ...
  { code: 'qa', name: 'Qatar',          flag: '🇶🇦', href: '/tools/distance-calculator-qatar', live: true },
  { code: 'sa', name: 'Saudi Arabia',   flag: '🇸🇦', href: '/tools/distance-calculator-saudi-arabia', live: true },
  { code: 'gb', name: 'United Kingdom', flag: '🇬🇧', href: '/tools/distance-calculator-uk', live: true },
  { code: 'us', name: 'United States',  flag: '🇺🇸', href: '/tools/distance-calculator-usa', live: true },
  { code: 'ca', name: 'Canada',         flag: '🇨🇦', href: '/tools/distance-calculator-canada', live: true },
  { code: 'de', name: 'Germany',        flag: '🇩🇪', href: '/tools/distance-calculator-germany', live: true },
  { code: 'fr', name: 'France',         flag: '🇫🇷', href: '/tools/distance-calculator-france', live: true },
  { code: 'it', name: 'Italy',          flag: '🇮🇹', href: '/tools/distance-calculator-italy', live: true },
  { code: 'es', name: 'Spain',          flag: '🇪🇸', href: '/tools/distance-calculator-spain', live: true },
  { code: 'nl', name: 'Netherlands',    flag: '🇳🇱', href: '/tools/distance-calculator-netherlands', live: true },
  ...
  { code: 'ar', name: 'Argentina',      flag: '🇦🇷', live: false },
