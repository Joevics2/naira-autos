...
const COUNTRIES: { code: string; name: string; flag: string; href?: string; live: boolean }[] = [
  ...
  { code: 'de', name: 'Germany',        flag: '🇩🇪', live: false },
  { code: 'fr', name: 'France',         flag: '🇫🇷', live: false },
  { code: 'it', name: 'Italy',          flag: '🇮🇹', live: false },
  { code: 'es', name: 'Spain',          flag: '🇪🇸', live: false },
  { code: 'nl', name: 'Netherlands',    flag: '🇳🇱', live: false },
