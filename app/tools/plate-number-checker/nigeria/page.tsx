  ...
  '@graph': [
    ...
    },
    {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Which Nigerian states does this checker currently cover?', acceptedAnswer: { '@type': 'Answer', text: 'Lagos, FCT (Abuja), Kano, Ogun, Anambra, Akwa Ibom, Enugu, Kaduna, Katsina, Niger, Jigawa, Borno, Kogi, Taraba, Ondo, Plateau, Kwara, and Ebonyi, with full LGA-level coverage cross-checked against official LGA counts for each (Ondo is 17 of 18, one confirmed-erroneous source entry excluded). More states are being added over time. For any state not yet covered, the tool will say so and point you to FRSC\'s official verification instead of guessing.' } },
      ],
    },
            ...
            <div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  { q: 'How do I check what LGA a plate number is from?', a: 'Enter the full plate above. This tool matches the first 3 letters against a verified database covering 18 regions so far — Lagos, FCT, Kano, Ogun, Anambra, Akwa Ibom, Enugu, Kaduna, Katsina, Niger, Jigawa, Borno, Kogi, Taraba, Ondo, Plateau, Kwara, and Ebonyi — with more states being added.' },
                  ...
                  { q: 'Which states does this checker cover right now?', a: 'Lagos, FCT (Abuja), Kano, Ogun, Anambra, Akwa Ibom, Enugu, Kaduna, Katsina, Niger, Jigawa, Borno, Kogi, Taraba, Ondo, Plateau, Kwara, and Ebonyi — each verified to match that state\'s official LGA count (Ondo is 17 of 18). Other states will say so plainly rather than guess, with a link to FRSC\'s official portal.' },
                ].map(({ q, a }) => (
