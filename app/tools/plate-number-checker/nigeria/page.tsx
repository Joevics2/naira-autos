  ...
  '@graph': [
    ...
    },
    {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Which Nigerian states does this checker currently cover?', acceptedAnswer: { '@type': 'Answer', text: 'Lagos, FCT (Abuja), Kano, Ogun, Anambra, Akwa Ibom, Enugu, Kaduna, Katsina, Niger, Jigawa, Borno, Kogi, Taraba, Ondo, Plateau, Kwara, Ebonyi, Abia, and Adamawa, with full LGA-level coverage cross-checked against official LGA counts for each (Ondo is 17 of 18 and Abia is 16 of 17 — a small number of source entries were confirmed incomplete or erroneous and excluded rather than guessed). More states are being added over time. For any state not yet covered, the tool will say so and point you to FRSC\'s official verification instead of guessing.' } },
      ],
    },
            ...
            <div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  { q: 'How do I check what LGA a plate number is from?', a: 'Enter the full plate above. This tool matches the first 3 letters against a verified database covering 20 regions so far — Lagos, FCT, Kano, Ogun, Anambra, Akwa Ibom, Enugu, Kaduna, Katsina, Niger, Jigawa, Borno, Kogi, Taraba, Ondo, Plateau, Kwara, Ebonyi, Abia, and Adamawa — with more states being added.' },
                  ...
                  { q: 'Which states does this checker cover right now?', a: 'Lagos, FCT (Abuja), Kano, Ogun, Anambra, Akwa Ibom, Enugu, Kaduna, Katsina, Niger, Jigawa, Borno, Kogi, Taraba, Ondo, Plateau, Kwara, Ebonyi, Abia, and Adamawa — each verified to match that state\'s official LGA count (Ondo is 17 of 18, Abia is 16 of 17). Other states will say so plainly rather than guess, with a link to FRSC\'s official portal.' },
                ].map(({ q, a }) => (
