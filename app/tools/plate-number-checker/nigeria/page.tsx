...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.naira.autos/tools/plate-number-checker/nigeria' },
  openGraph: {
    ...
    url: 'https://www.naira.autos/tools/plate-number-checker/nigeria',
  },
};
...
const SCHEMA = {
  ...
  '@graph': [
    {
      '@type': 'WebPage',
      '@id': 'https://www.naira.autos/tools/plate-number-checker/nigeria',
      ...
      breadcrumb: { '@type': 'BreadcrumbList', itemListElement: [
        ...
        { '@type': 'ListItem', position: 4, name: 'Nigeria', item: 'https://www.naira.autos/tools/plate-number-checker/nigeria' },
      ]},
    },
    {
      '@type': 'FAQPage',
      mainEntity: [
        ...
        { '@type': 'Question', name: 'How do I check what LGA a Nigerian plate number is from?', acceptedAnswer: { '@type': 'Answer', text: 'Enter the full plate number above. This tool reads the first 3 letters and matches them against a verified LGA database covering all 36 states and the FCT — essentially complete national coverage, with one known gap (Ondo\'s Ilaje LGA) documented rather than guessed at.' } },
        ...
        { '@type': 'Question', name: 'Which Nigerian states does this checker currently cover?', acceptedAnswer: { '@type': 'Answer', text: 'All 36 states plus the FCT — 773 LGA codes verified against official LGA counts for every state. One entry is intentionally left incomplete rather than guessed: Ondo is 17 of 18, since one source entry for its 18th LGA was confirmed erroneous and excluded. If a plate\'s prefix genuinely isn\'t recognised, the tool says so plainly and points you to FRSC\'s official portal instead of showing a made-up result.' } },
      ],
    },
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 py-16 space-y-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <div className="space-y-6">
              ...
              <div>
                <h2 className="text-xl font-black uppercase text-foreground mb-3" style={{ fontFamily: "'Barlow Condensed', Impact, sans-serif" }}>Coverage — All 36 States Plus the FCT</h2>
                <div className="space-y-3 text-sm text-muted-foreground leading-relaxed">
                  <p>LGA-level lookup covers <strong className="text-foreground">all 36 states plus the FCT</strong> — {COVERED_STATES.reduce((sum, s) => sum + s.verified, 0)} verified codes in total, each state's count cross-checked against its official LGA total. One entry is intentionally incomplete rather than guessed: Ondo is 17 of 18, since one source entry for its 18th LGA was confirmed erroneous and excluded. If a plate's prefix genuinely isn't recognised, the tool tells you plainly rather than showing a made-up result, and points you to FRSC instead.</p>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  { q: 'How do I check what LGA a plate number is from?', a: 'Enter the full plate above. This tool matches the first 3 letters against a verified database covering all 36 states plus the FCT — 773 LGA codes, essentially complete national coverage.' },
                  ...
                  { q: 'Which states does this checker cover right now?', a: 'All 36 states plus the FCT — 773 verified LGA codes, cross-checked against official LGA counts for every state. Ondo is 17 of 18 (one source entry for the 18th LGA was confirmed erroneous and excluded rather than guessed). Anything genuinely unrecognised is flagged plainly, with a link to FRSC\'s official portal.' },
                ].map(({ q, a }) => (
