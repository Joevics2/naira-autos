...
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
  ...
  let description =
    'Browse thousands of verified cars for sale in Nigeria. Filter by brand, location, price, and vehicle type. Find the best deals on Toyota, Honda, Mercedes, BMW, and more.';
  let keywords =
    'used cars Nigeria, buy cars Lagos, car dealers Nigeria, second hand cars, car marketplace Nigeria';
