...
import { Edit, Trash2, Eye, CheckCircle, Clock, XCircle, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 py-8 mb-20">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-foreground mb-2">Pending Listings</h1>
      ...
      {listings.length === 0 ? (
        <Card>
          <CardContent className="pt-6 text-center py-12">
            ...
            <p className="text-muted-foreground mb-4">All your listings have been processed</p>
