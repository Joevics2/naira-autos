...
export async function generateStaticParams() {
  ...
  const { data } = await supabase.from('vehicle_maintenance').select('brand_slug, model_name, vehicle_type, year').eq('is_published', true);
          ...
          '@graph': [
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { '@type': 'ListItem', position: 6, name: 'Maintenance', item: `https://www.naira.autos/${params.type}/${params.brand}/${params.model}/${params.year}/maintenance` },
              ],
            },
          ],
        })}}
