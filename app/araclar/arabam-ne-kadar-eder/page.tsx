      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="max-w-screen-lg mx-auto px-4 sm:px-6 pb-16 space-y-14">
          ...
          <section className="prose prose-sm dark:prose-invert max-w-none text-muted-foreground leading-relaxed space-y-5">
            ...
            <p>Arabanızın gerçek piyasa değerini bilmek, dünyanın her yerinde satışa çıkarmadan, takasa vermeden veya bir satın alma pazarlığı yapmadan önce atılacak en önemli adımdır. Fiyatı çok yüksek belirlemek ilanınızın satılmadan kalmasına neden olur. Çok düşük belirlemek ise gerçek parayı masada bırakmak demektir. Buradaki zorluk, <strong className="text-foreground">"piyasa değeri"nin tek bir sayı olmamasıdır</strong> — ülkeye, para birimine, belirli bir markaya yönelik yerel talebe ve her arabanın kendi geçmişine ve durumuna göre değişir.</p>
