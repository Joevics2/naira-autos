...
export default function BlogIndexClientNl({ posts }: { posts: BlogPost[] }) {
  ...
  return (
    <div>
      ...
      <div className="relative max-w-md mb-8">
        ...
        <Input
          placeholder="Artikelen doorzoeken..."
          value={searchTerm}
      ...
      {filteredBlogs.length === 0 ? (
        <div className="text-center py-12">
          <p className="text-muted-foreground text-lg">
            {searchTerm ? 'Geen artikelen gevonden' : 'Nog geen Nederlandstalige artikelen — kom snel terug.'}
          </p>
        </div>
      ) : (
